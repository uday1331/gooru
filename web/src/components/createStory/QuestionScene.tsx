...
export const QuestionScene: React.FC<RouteComponentProps<{ id: string }>> = ({
  match: {
    params: { id },
  },
}) => {
  ...
  return (
    ...
    >
      ...
      <Box
        background="rgba(150, 156, 184, 0.8)"
        position="absolute"
        bottom={0}
        w="100%"
        p={8}
        ...
        <Grid templateColumns="50% 50%" mt={8}>
          <Box mr={2}>
            <InputGroup>
              ...
              <InputRightElement
                children={
                  <Radio size="lg" variantColor="green" value="1"></Radio>
                }
              />
            </InputGroup>
            <InputGroup>
              ...
              <InputRightElement
                children={
                  <Radio size="lg" variantColor="green" value="2"></Radio>
                }
              />
            </InputGroup>
          </Box>
          <Box ml={2}>
            <InputGroup>
              ...
              <InputRightElement
                children={
                  <Radio size="lg" variantColor="green" value="3"></Radio>
                }
              />
            </InputGroup>
            <InputGroup>
              ...
              <InputRightElement
                children={
                  <Radio size="lg" variantColor="green" value="4"></Radio>
                }
              />
            </InputGroup>
          </Box>
